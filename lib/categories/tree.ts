...
export const CATEGORY_TREE: CategoryGroup[] = [
  {
    ...
    categories: [
      ...
      },
      {
        ...
        icon: "send",
        color: "#3949AB",
        // << מ-27.08, החלטת משתמש: שם הילד שונה מ"ביט" ל"העברת כספים" —
        //    זהה לשם האם. מאז 26.08 אין עוד פיצול לפי ערוץ (ביט מול
        //    ערוצים אחרים), אז "ביט" כשם ילד יחיד היה מדויק מדי מול מה
        //    שבפועל מוצג בבורר הסיווג הידני (manualCategories).
        children: [{ slug: "transfers_out.bit", name: "העברת כספים" }],
      },
      {
